CLASS zcl_rap100_gen_data_450 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_450 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA :
        group_id    TYPE    string value '450',
        attachment  TYPE    /dmo/attachment,
        file_name   TYPE    /dmo/filename,
        mime_type   TYPE    /dmo/mime_type.

*   clear data
    DELETE FROM ZRAP100_ATRAV450.
* DELETE FROM zrap100_atrav450.

    " insert travel demo data
    INSERT ZRAP100_ATRAV450 FROM (
        SELECT
